...
class ViewController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    var API_KEY = "ADD_YOUR_API_KEY_HERE"
            ...
            if (errorObj.dictionaryValue != [:]) {
                ...
                if faceAnnotations != nil {
                    ...
                    for (emotion, total) in emotionTotals {
                        ...
                        let percent: Double = round(likelihood * 100)
                ...
                let numLogo: Int = logoAnnotations.count
                if numLogo > 0 {
                    let logo = logoAnnotations[0]["description"].stringValue
                    self.labelResults.text.appendContentsOf(", \(logo)")
                }
                ...
                var texts = [String]()
                if numText > 0 {
                    var textResult: String = "Texts found: "
                    ...
                    self.labelResults.text = self.labelResults.text + "\n\n" + textResult
                } else {
                    self.labelResults.text = self.labelResults.text + "\n\nNo text found"
                }
